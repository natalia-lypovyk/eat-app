    ...
    <Styled.Wrapper>
      <Styled.Container direction="row">
        <Flex direction="column">
          <Styled.Heading>A few highlights from our menu</Styled.Heading>
          <Text
            styled={{
              Text: css`
                color: var(--c-light);
          ...
          >
            We cater for all dietary requirements, but here is a glimpse at some of our diner;s favourites. Our menu is
        ...
        <Flex direction="column">
          {examples.map((example) => (
            <Example key={example.title} info={example} />
          ))}
        </Flex>
      </Styled.Container>
    </Styled.Wrapper>
